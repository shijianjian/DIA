...
def save_checkpoint(epoch, model_state, optim_state, logdir, name="last"):
    last_model = os.path.join(logdir, f'{name}.model')
    last_optim = os.path.join(logdir, f'{name}.optim')
    last_config = os.path.join(logdir, f'{name}.config')
...
def save_linear_checkpoint(linear_optim_state, logdir, name="last"):
    last_linear_optim = os.path.join(logdir, f'{name}.linear_optim')
