...
from training.contrastive_loss import get_similarity_matrix, NT_xent_neg
...
def train(P, epoch, model, criterion, optimizer, scheduler, loader, logger=None,
    ...
    for n, (images, labels) in enumerate(loader):
        ...
        images3 = torch.cat([
            P.shift_trans(
                images2, k, diffusion=True, diffusion_offset=P.diffusion_offset,
                diffusion_upper_offset=P.diffusion_upper_offset
        ...
        loss_sim = NT_xent_neg(sim_matrix, temperature=0.5) * P.sim_lambda
        ...
        if num_batches_per_epoch is not None and n >= num_batches_per_epoch:
            break
